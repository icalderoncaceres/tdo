...
<h3 class="modal-title " ><img src="galeria/img/logos/mascota.png" width="50" height="51"><span id="usr-reg-title" class="marL15">Inscribete</span>
</h3>
</div>
<form id="usr-reg-form" action="fcn/f_usuarios.php" method="post" class="form-inline">
	...
	data-title="Información Personal" data-step="1" data-type="e" id="personal">
	<div class="row">
	<div class="col-xs-12 ">
	...
	Información Personal</div>
		...
		<div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6 input">
		<input type="date" " id="e_fechanac" name="e_fechanac">
                </input>
		</div>
