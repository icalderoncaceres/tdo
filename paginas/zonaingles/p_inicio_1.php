	...
	<div class="container pad20">
		...
		<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9" name="planes" id="planes">
			...
			<div class="col-xs-12 col-sm-6">
				...
				<div class="col-xs-9">
					<div class="col-xs-12"><span class="t18">0276-6518167</span></div>
					<div class="col-xs-12"><span class="t18">0414-7229007</span></div>
					<div class="col-xs-12"><span class="t18">0416-179-3965</span></div>
		...
		<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 text-justify t16" name="instrucciones" id="instrucciones">
			<div class="col-xs-12">
				...
				<p>
					<h3><u>Paso 2:</u></h3>
					Deposita o transfiere el monto correspondiente a algunas de las siguientes cuentas bancarias <br><br>
					<ul>
						<li>
							<u><b>Banco bicentenario: </b></u> cuenta de ahorros 0175-0001-53-00-105-80811 a nombre de Iv&aacute;n Dario Calderon C&aacute;ceres, 
							c&eacute;dula V-14.942.358, email ivandario2010@gmail.com, tel&eacute;fonos 0276-6518167 / 0416-179-3965 / 0414-7229007
						</li><br>
						<li>
							<u><b>Banco provincial: </b></u> cuenta corriente 0108-0128-11-0100169688 a nombre de Cruz Belia C&aacute;ceres, 
							c&eacute;dula V-26.788.901, email cacerescruzbelia@gmail.com, tel&eacute;fonos 0276-6518167 / 0416-179-3965 / 0414-7229007 
						</li>
						<!--
						<br>
						<li>
							<u><b>Banco fondo com&uacute;n: </b></u> cuenta corriente xxxx-xxxx-xx-xx-xxx-xxxxx a nombre de Cruz Belia C&aacute;ceres, 
							c&eacute;dula V-26.788.901, email cacerescruzbelia@gmail.com, tel&eacute;fonos 0276-6518167 / 0416-179-3965 / 0414-7229007
						</li>
						-->
					</ul>
					...
					<form id="frm-reservacion" name="frm-reservacion">
						...
						<div class="form-group">
							<select id="select-banco" name="select-banco" class="form-select" type="text" placeholder="Banco">
								...
								<option  value="2">Fondo com&uacute;n</option>
