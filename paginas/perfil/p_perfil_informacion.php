...
<div class="contenedor" style="margin-top: 25px">
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			...
			<div class="perfil-info-menu  mar-perfil-informacion">
				...
				<div data-href="#ventas">
					<i class="fa fa-share"></i> Informaci&oacute;n de Ventas
				</div>
				<br>
				<div>
 ...
 echo "{$row2["nombre"]}, $estado $direccion"?>
			...
			<?php if(isset($edit)):?>
			<div class="text-right marR20">
				<a class="pointer" data-toggle="modal" data-target="#info-social" id="btn-info-social" name="btn-info-social">Editar</a>
			</div>
			<?php endif;?>
			<br> <br>
