<?php
	...
	if(isset($_SESSION["id"])){
        include "chat.php";
		if($usua->hasChildren())
			echo "<br><div class='text-center'><a class='btn btn-primary' role='button' href='monitoreo' target='_blank'>Sistema de monitoreo</a></div>";
	}else{
		?>
		<br>
		...
		<form id="usr-log-form" name="usr-log-form" action="fcn/f_usuarios.php" method="POST">
			...
			<input type="checkbox" id="recordar" name="recordar" data-valor="1" checked> No cerrar sesi&oacute;n</input>
				</div>
				<hr>
			...
			<a>&#191;Olvidaste la Contrase&#241;a?</a>
				...
				<div style="padding: 10px;">
					<p class="t12 text-center">&#191;Eres nuevo en Educacionenlinea.com.ve?</p>					
				</div>
		</form>		
		<a href="registro"><button class="btn2 btn-default btn-group-justified">Inscribete</button></a>
		<br><br>		
		</div>
		<?php
	}
